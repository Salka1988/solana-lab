...
fn burn_from_user_ix(
    ...
    Instruction::new_with_bytes(
        modular_issuer::id(),
        &modular_issuer::instruction::BurnFromUser { amount }.data(),
        modular_issuer::accounts::BurnFromUser {
            issuer_authority,
            protocol_config,
            mint_config,
            supply_stats,
...
fn burn_from_user_rejects_amount_above_tracked_outstanding() {
    ...
    test_support::assert_failure_contains(&result.unwrap_err(), "BurnAmountExceedsOutstanding");
}
