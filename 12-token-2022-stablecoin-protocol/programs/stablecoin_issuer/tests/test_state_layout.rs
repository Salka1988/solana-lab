...
fn protocol_config_space_matches_serialized_len() {
    let account = stablecoin_issuer::ProtocolConfig {
    ...
    assert_eq!(
        ...
        stablecoin_issuer::ProtocolConfig::SPACE
    );
}

#[test]
fn stablecoin_mint_config_space_matches_serialized_len() {
    let account = stablecoin_issuer::StablecoinMintConfig {
    ...
    assert_eq!(
        serialized_len(&account),
        stablecoin_issuer::StablecoinMintConfig::SPACE
    );
}

#[test]
fn global_supply_stats_space_matches_serialized_len() {
    let account = stablecoin_issuer::GlobalSupplyStats {
        protocol_config: Pubkey::new_unique(),
        mint: Pubkey::new_unique(),
    ...
    assert_eq!(
        serialized_len(&account),
        stablecoin_issuer::GlobalSupplyStats::SPACE
    );
}

#[test]
fn issuer_config_space_matches_serialized_len() {
    let account = stablecoin_issuer::IssuerConfig {
        protocol_config: Pubkey::new_unique(),
    ...
    assert_eq!(
        serialized_len(&account),
        stablecoin_issuer::IssuerConfig::SPACE
    );
}

#[test]
fn issuer_stats_space_matches_serialized_len() {
    let account = stablecoin_issuer::IssuerStats {
        protocol_config: Pubkey::new_unique(),
    ...
    assert_eq!(
        serialized_len(&account),
        stablecoin_issuer::IssuerStats::SPACE
    );
}
