...
fn initialize_bridge_config_ix(
    ...
    Instruction::new_with_bytes(
        stablecoin_bridge_receiver::id(),
        &stablecoin_bridge_receiver::instruction::InitializeBridgeConfig { per_message_limit }
            .data(),
...
fn initialize_bridge_config_creates_expected_state() {
    ...
    let config = test_support::deserialize_account::<stablecoin_bridge_receiver::BridgeConfig>(
        &svm,
        &bridge_config,
    );
...
fn consume_valid_message_records_nonce_receipt() {
    ...
    let consumed = test_support::deserialize_account::<stablecoin_bridge_receiver::ConsumedMessage>(
        &fixture.svm,
        &consumed_message,
    );
